...
import pla from "../assets/svgs/pla.svg";
...
export const serviceList9 = [
  {
    ...
    icon: gpt,
    description:
      "ChatGPT which is based on OpenAI GPT 3.5 is a big leap forward in terms of what AI can achieve in features. We will be able to detect any ChatGPT 3 written content",
  },
  {
    id: 2,
    linkUrl: "#",
