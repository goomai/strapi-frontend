    ...
    <div className="container-sm my-12">
      ...
      <div className="para ">
        ...
        <p>
          ...
          application that allows developers to create and share documents that
          contain live code, equations, visualizations, and narrative text. In
          terms of deep learning, popular frameworks include TensorFlow and
          Keras.
        </p>
        <p>
        ...
        <p>
          We will provide the necessary material on other critical technologies
          related to AI, ML and Data Science including Natural Language
          Processing (NLP), Computer Vision, Reinforcement Learning, Robotics
          and big data technologies like Apache Spark and Hadoop.
        </p>
        <p>
          ...
          exploratory data analysis, data cleaning, and feature engineering, and
