...
function Terms() {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Goom.AI</title>
        <meta
          name="description"
      ...
      <div className="container-sm text-dark my-8">
        <h1>Terms and Conditions</h1>
        <div>
          <p>
            Throughout the site, the terms “we”, “us” and “our” refer to the Keevs Health India Pvt Ltd.
